    ...
    <form action={formAction} className="space-y-8">
      ...
      <section aria-labelledby="meta-heading">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          ...
          {/* URL zdjęcia */}
          <div className="mt-5">
            <label htmlFor="image_url" className="block text-sm font-semibold text-gray-700 mb-1.5">
              URL zdjęcia
            </label>
            <input
              id="image_url"
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-green-700 text-gray-900"
              placeholder="https://…"
            />
          </div>
        </div>
